...
public class PrefabEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            Toast.makeText(PrefabEvents.this,""+value, Toast.LENGTH_SHORT).show();
    ...
    private void prepareMenuData() {
        ...
        DatabaseReference ref = database.getReference("Prefab");
...
// Attach a listener to read the data at our posts reference
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(PrefabEvents.this, "database read failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}