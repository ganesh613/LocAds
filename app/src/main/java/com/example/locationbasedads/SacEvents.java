...
public class SacEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            Toast.makeText(SacEvents.this,""+value, Toast.LENGTH_SHORT).show();
    ...
    private void prepareMenuData() {
        ...
        DatabaseReference ref = database.getReference("Sac");
...
// Attach a listener to read the data at our posts reference
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(SacEvents.this, "database read failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}