...
public class GroundEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //
            //     Toast.makeText(GroundEvents.this,""+value, Toast.LENGTH_SHORT).show();
    ...
    private void prepareMenuData() {
        ...
        DatabaseReference ref = database.getReference("Ground");
...
// Attach a listener to read the data at our posts reference
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(GroundEvents.this, "database read failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}