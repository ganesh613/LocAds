...
public class AcademicEvents extends AppCompatActivity {
    ...
    private void prepareMenuData() {
        ...
        DatabaseReference ref = database.getReference("AcademicBlock");
...
// Attach a listener to read the data at our posts reference
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(AcademicEvents.this, "database read failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}